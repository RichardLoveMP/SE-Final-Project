...
public class DiagnosisStatisticsBean {
	...
	public DiagnosisStatisticsBean(String zipCode, long zipStats, long regionStats, long allStats) {
	 ...
	 */
	public DiagnosisStatisticsBean(String zipCode, long zipStats, long regionStats, long allStats, Date startDate, Date endDate) {
		this.zipCode = zipCode;
		this.zipStats = zipStats;
		this.regionStats = regionStats;
	 ...
	 * @param zipStats The count of diagnoses for the zip code
	 * @param regionStats The count of diagnoses for the region
	 * @param stateStats count of diagnoses in state
	 * @param allStats
	 * @param startDate The beginning of the data's time period
	 * @param endDate The end of the data's time period
	 */
	...
	public long getAllStats(){ return this.allStats;}
	public void setAllStats(long allStats){ this.allStats = allStats;}

	public long getStateStats(){ return this.allStats;}
	public void setStateStats(long allStats){ this.allStats = allStats;}
