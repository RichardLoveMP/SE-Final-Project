...
public enum TransactionType {
	...
	/**CREATE_PREREGISTERED*/
	CREATE_PREREGISTERED(104,"Create Pre-registered patient", "User preregistered as a patient", false),
	/**ACTIVATE_PREREGISTERED*/
	ACTIVATE_PREREGISTERED(105,"Activate Pre-registered patient", "User activated as a patient", true),
	/**CREATE_PREREGISTERED*/
	DEACTIVATE_PREREGISTERED(106,"Deactivate Pre-registered patient", "User deactivate as a patient", true),
	/**LHCP_CREATE*/
	...
	/**HCP_SENT_PRESCRIPTION**/
	HCP_SENT_PRESCRIPTION(5000, "HCP sent a prescription", "Prescription sent to pharmacy", false),
	;
	/**
