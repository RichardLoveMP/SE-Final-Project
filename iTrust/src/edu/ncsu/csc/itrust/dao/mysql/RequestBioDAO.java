...
public class RequestBioDAO {

    private DAOFactory factory;


    public RequestBioDAO(DAOFactory factory) {
     ...
     * @return True if an influenza epidemic is occuring for the specified parameters, false otherwise
     * @throws ITrustException
     * @throws DBException
     */
    public boolean isInfluenzaEpidemic(String zipcode, Date d) throws ITrustException, DBException {
        ...
        Calendar c = new GregorianCalendar();
        c.setTime(d);
        String subqueryOfficeDiagnosis = "(SELECT VisitID FROM ovdiagnosis WHERE ICDCode = 487.00)"; //111 3957
        String subqueryPatientZip = "(SELECT MID FROM patients WHERE zip LIKE '" + zipcode.substring(0, 3) + "%')"; //zip = 276XX
    ...
    /**
     * Gets the threshold to determine if an influenza epidemic is occuring
     ...
     * @param icd Code representing a disease
