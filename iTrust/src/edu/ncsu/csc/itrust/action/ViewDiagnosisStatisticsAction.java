...
public class ViewDiagnosisStatisticsAction {
	...
	public boolean isMalariaEpidemic(String weekDate, String zip, String thresholdStr) throws DBException, ParseException {
		...
		return weekTotal != 0 && ((double)weekTotal*100/(double)threshold) > avg &&
				(	( weekTotalL != 0 && ((double)weekTotalL*100/threshold) > avgL ) ||
						( weekTotalN != 0 && ((double)weekTotalN*100/threshold) > avgN ) );
	}
}