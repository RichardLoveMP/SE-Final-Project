...
public class EditPatientAction extends PatientBaseAction {
	...
	public void setPharmacy(String pharmacy) throws DBException{
		PatientBean p = patientDAO.getPatient(this.getPid());
		p.setPharmAddress(pharmacy);
		patientDAO.editPatient(p, loggedInMID);
	}

	public String getPharmacy() throws DBException, ITrustException{
		String pharmAddress = patientDAO.getPharmacy(this.getPid());
		return pharmAddress;
	}
}
