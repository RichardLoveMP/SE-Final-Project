...
public class TestDataGenerator {
	...
	public void deadpatient1() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/uc20.sql");
	} //NEW
	...
	public void healthData2() throws SQLException, FileNotFoundException,
			IOException { //UC 92
		new DBBuilder(factory).executeSQLFile(DIR + "/healthdata2.sql");
	}
	...
	/**
	 * Adds Pre Registered patient Brody Franco, used in the testing of UC92.
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void prePatient1() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/prePatient1.sql");
	}
