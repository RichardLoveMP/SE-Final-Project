...
public class EditPatientActionTest extends TestCase {
	...
	public void testSetPharmacy() throws Exception {
		gen.patient1();
		action = new EditPatientAction(factory, 1L, "1");
		PatientDAO po = TestDAOFactory.getTestInstance().getPatientDAO();
		
		action.setPharmacy("1301 W Springfield Ave, Urbana, IL 61801");
		PatientBean pb1 = po.getPatient(1l);

		assertTrue(pb1 != null);
		assertTrue(pb1.getPharmAddress() != null);

		assertTrue(pb1.getPharmAddress().equals("1301 W Springfield Ave, Urbana, IL 61801"));
		action.setPharmacy("1302 W Springfield Ave, Urbana, IL 61801");
		PatientBean pb2 = po.getPatient(1l);
		assertTrue(pb2.getPharmAddress().equals("1302 W Springfield Ave, Urbana, IL 61801"));
	...
	public void testGetPharmacy() throws Exception {
		...
		action = new EditPatientAction(factory, 1L, "1");
                ...
                action.setPharmacy("1301 W Springfield Ave, Urbana, IL 61801");
                String pharmacy = action.getPharmacy();
		assertTrue(pharmacy.equals("1301 W Springfield Ave, Urbana, IL 61801"));
	}
}
