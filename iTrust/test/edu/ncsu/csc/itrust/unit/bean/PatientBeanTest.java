...
public class PatientBeanTest extends TestCase {
	...
	public void testBean() {
		...
		assertEquals(1, p.getIsRegistered());
	}
	public void testUnregisteredPatient() {
		PatientBean p = new PatientBean();
		p.setBloodType(BloodType.ABNeg);
		p.setDateOfBirthStr("bad date");
		p.setCity("Raleigh");
	...
	public void testPatientPharmacy() {
		PatientBean p = new PatientBean();
		p.setBloodType(BloodType.ABNeg);
		p.setDateOfBirthStr("bad date");
		p.setCity("Raleigh");
		...
		p.setConfirmPassword("confirm");
		p.setIsRegistered(0);
		p.setPharmAddress("1301 W Springfield Ave, Urbana, IL 61801");
		...
		assertEquals("confirm", p.getConfirmPassword());
		assertEquals(0, p.getIsRegistered());
		assertEquals("1301 W Springfield Ave, Urbana, IL 61801", p.getPharmAddress());
	}
