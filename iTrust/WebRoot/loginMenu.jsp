...
%>
	...
	<br /><br />
	<a style="font-size: 80%;" href="/iTrust/util/resetPassword.jsp">Reset Password</a><br />
	<a name="prereg" style="font-size: 80%;" href="/iTrust/util/preRegistration.jsp">Pre-register</a>
...
%>
	...
	<a style="font-size: 80%;" href="/iTrust/util/resetPassword.jsp">Reset Password</a> <br />
	<a name="prereg2" style="font-size: 80%;" href="/iTrust/util/preRegistration.jsp">Pre-register</a>
