...
<%
	...
	if (formIsFilled) {
		...
		p.setIsRegistered(p2.getIsRegistered());
		try {
...
<table cellspacing=0 align=center cellpadding=0>
	<tr>
		...
		<table class="fTable" align=center style="width: 350px;">
			...
			<%-- <tr>
				<td class="subHeaderVertical">isRegistered:</td>
				<td>
					<input name="isRegistered" value="<%= p.getIsRegistered() %>" maxlength="1" type="number" size="1">
				</td>
			</tr> --%>
		</table>
		<br />
