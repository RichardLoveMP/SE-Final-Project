<div class="panel panel-default">
	...
	<div class="panel-body" id="info-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/hcp-uap/viewPreRegisteredPatients.jsp">Pre-registered Patients</a>
...
<div class="panel panel-default">
	<div class="panel-heading"  anim-type="collapse" anim-target="#other-menu">
		<h2 class="panel-title" id="other">Other</h2>
	</div>
	<div class="panel-body" id="other-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/hcp/viewCauseOfDeath.jsp" id="COD">View Cause of Death Trends</a>
		</ul>
	</div>
</div>
